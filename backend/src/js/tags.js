...
function addRowForm(tagData) {
    ...
    addCell = addRow.insertCell(0); addCell.textContent = tagData.get('tagName')
    addCell = addRow.insertCell(1); addCell.textContent = tagData.get('tagAddress')
    addCell = addRow.insertCell(2); addCell.textContent = tagData.get('tagType')
}